                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach ($order->products as $product)
                                        <tr>
                                            ...
                                            <td><input type="number" name="quantities[]" value="{{ $product->pivot->quantity }}" min="1" class="form-control input-sm quantity" data-price="{{ $product->sale_price }}"></td>
                                            <td class="price" data-price="{{ $product->sale_price }}">{{ number_format($product->sale_price * $product->pivot->quantity, 2) }}</td>
                                            <td>
                                ...
                                <h4>@lang('site.total') : <span class="total-price">{{ number_format($order->price, 2) }}</span></h4>

                                <button class="btn btn-primary btn-block disabled" id="edit-order-form-btn"><i class="fa fa-edit"></i> @lang('site.edit_order')</button>
